...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Pendaftaran Kebudayaan<br>Benda</h2>
      <p class="mt-2 text-lg/8 text-gray-600">loram ipsum dolor</p>
    </div>
<form>
